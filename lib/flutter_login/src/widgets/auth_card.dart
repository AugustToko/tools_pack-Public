          ...
          final child = (index == 0)
              ? _buildLoadingAnimator(
                  ...
                  child: _LoginCard(
                    ...
                    onSignBtnPressed: widget?.onSignPressed,
                    onForgotBtnPressed: widget?.onForgotPressed,
                    onSubmitCompleted: () {
  ...
  Widget _buildForgotPassword(ThemeData theme, LoginMessages messages) {
    return FadeIn(
      ...
      child: FlatButton(
        ...
        onPressed: widget.onForgotBtnPressed,
...
//        onPressed: buttonEnabled ? _switchAuthMode : null,
        onPressed: widget.onSignBtnPressed,
