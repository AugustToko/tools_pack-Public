...
import 'package:toolspack/widgets/banner/banner_indicator.dart';

typedef GetWidgetCallback = Widget Function(int index);

class MyBannerSwiper extends StatefulWidget {
  final int length;
...
class _BannerSwiperState extends State<MyBannerSwiper> {
  @override
  void didUpdateWidget(MyBannerSwiper oldWidget) {
  ...
  MySquareIndicator squareIndicator;

  GlobalKey<MyMSquareIndicator> indicatorKey = GlobalKey<MyMSquareIndicator>();
...
//        });
    ...
    if (widget.showIndicator) {
      squareIndicator = MySquareIndicator(
